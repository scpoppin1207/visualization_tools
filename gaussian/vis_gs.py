#!/usr/bin/env python
"""CLI entry point for local Gaussian rendering with Mitsuba."""
...
def main():
    ...
    if args.input_file:
        ...
        GaussianVisualizer.batch_render(args, render_params, camera_preset="local", output_suffix="_mitsuba")
